...
* R's functional aspects make me wish that I knew more Lisp. I'm slowly picking it up, but I've currently not got any further than chapter 4 of _Structure and Interpretation of Computer Programs_. R's clear Scheme inspiration makes Lisp books a lot less fun to read; It's like I've already been spoiled on some of the best bits.
* I haven't done enough OOP in R. My only real experience of it is with S3. S4 looks enough like CLOS that I expect that I will revisit it at some point after picking up Common Lisp, but that will just be to play around.
